    ...
    constructor({timestamp , lastHash, hash,nonce,difficulty,data})
     ...
     static mineBlock({lastBlock, data})
     {
        ...
        do
         ...
         while(hexToBinary(hash).substring(0,difficulty) !=='0'.repeat(difficulty)); //We'll be doing a difficulty check based on the binary version of the hash....Their is no need to convert every 
